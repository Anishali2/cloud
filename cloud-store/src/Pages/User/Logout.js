...
export default function Delete(props) {
  ...
  const alert = useSelector((state) => state.users.logoutAlert)
  const navigate = useNavigate()


const hideModel =() => {
  dispatch({type:'LOG_OUT',payload:{alert:false,user:{}}})
}
const deleteRequest = async(id) => {
  dispatch({type:'SET_CURRENT_USER',payload:{login_state:false,user:{}}})
                  ...
                  <div className="sm:flex sm:items-start">
                    ...
                    <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      ...
                      <div className="mt-2">
                        ...
                        Are you sure you want to logout with this Account. This action cannot be undone.
                        </p>
                      </div>
                    </div>
                  </div>
