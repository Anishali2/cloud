...
const handleChange = (e) => {
  ...
  useEffect (() => {
    ...
    const checkedProducts = objchanged.filter(category => category[1]).map(category => category[0]);

    const newFilter = products.filter(({category}) => checkedProducts.includes(category));
    setNewFil(newFilter);
              ...
              >
                <Dialog.Panel className="ml-auto relative max-w-xs w-full h-full bg-white shadow-xl py-4 pb-12 flex flex-col overflow-y-auto">
                  ...
                  <form className="mt-4 border-t border-gray-200">
                    ...
                    <ul role="list" className="font-medium text-gray-900 px-2 py-3 transition ">
                        ...
                        <Disclosure.Panel className="pt-6">
                          <div className="space-y-4">
                              <div className="flex items-center">
                                ...
                                />
                                <label className="ml-3 text-sm text-gray-600"> Men </label>
                              </div>
                              <div className="flex items-center">
                                <input
                                  type="checkbox"
