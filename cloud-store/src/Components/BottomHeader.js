...
import {userNavigation,solutions,recentPosts,user} from '../assets/constants'
...
export default function BottomHeader() {
  ...
  const openSearchBox = () => {
    dispatch({type:'SEARCH_BOX',payload:{searchAlert:true,products:{}}})
  }
  return (
           ...
           ? 
              ...
              <div className="mt-3 xl:w-96">
                <div className="input-group relative flex  items-stretch w-full mb-4">
                  ...
                  <button onClick={() => openSearchBox()} className="btn flex  w-full px-3 py-3 text-indigo-600 font-medium text-xs leading-tight uppercase rounded border hover:bg-[#dad9d9] hover:shadow-lg focus:shadow-lg focus:outline-none focus:ring-0 active:shadow-lg transition duration-150 ease-in-out  items-center" type="button" id="button-addon2">
